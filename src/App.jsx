...
import { Heart, Shield, Users, BookOpen, Mail, Phone, MapPin, Calendar, ArrowRight, Menu, X } from 'lucide-react'
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Explore os princípios essenciais para uma gestão eficaz de cuidados em enfermagem, focando na qualidade e segurança do paciente.",
      date: "2025-01-20",
      category: "Gestão",
      readTime: "5 min"
    },
    {
      ...
      excerpt: "Como as novas tecnologias estão transformando a prática da enfermagem e melhorando os resultados dos pacientes.",
      date: "2025-01-18",
      category: "Tecnologia",
      readTime: "7 min"
    },
    {
      ...
      excerpt: "Estratégias baseadas em evidências para reduzir infecções hospitalares e promover um ambiente seguro.",
      date: "2025-01-15",
      category: "Segurança",
      readTime: "6 min"
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <img src={logo} alt="Carol Lobato Saúde" className="h-10 w-auto" />
              <div>
                <h1 className="text-xl font-bold text-slate-900">Carol Lobato</h1>
                <p className="text-sm text-teal-600">Gestão de Cuidados</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-slate-600">contato@carollobatosaude.com</p>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                <img src={logo} alt="Carol Lobato Saúde" className="h-8 w-auto filter brightness-0 invert" />
                <div>
                  <h4 className="text-lg font-bold">Carol Lobato</h4>
                  <p className="text-sm text-slate-400">Gestão de Cuidados</p>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li>contato@carollobatosaude.com</li>
                <li>(11) 99999-9999</li>
              </ul>
            </div>
          </div>
